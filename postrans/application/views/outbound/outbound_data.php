        ...
        foreach ($row->result() as $key => $data) { ?>
          <tr>
            ...
            <td class="text-center">
              <a href="<?= site_url('barang/outbound/' . $data->id_outbound) ?>" class="btn btn-success btn-xs" title="Lihat data barang">
                <i class="fa fa-eye"></i> Data Barang
              </a>
            </td>
            <td class="text-center" width="160px">
              <a href="<?= site_url('outbound/edit/' . $data->id_outbound) ?>" class="btn btn-primary btn-xs">
                <i class="fa fa-pencil"></i> Ubah
              </a>
              <a href="<?= site_url('outbound/del/' . $data->id_outbound) ?>" onclick="return confirm('Yakin Ingin Menghapus Data?')" class="btn btn-danger btn-xs">
